        ...
        <>
            ...
            >
                <Stack spacing='lg'>
                    ...
                    <Text>
                        В 2021 году при поддержке Фонда Фридриха Эберта и программы “Зеленые города” в Санкт-Петербурге прошла неконференция GreenDating, на которой участники и эксперты из разных городов России, чаще чем что-то еще, говорили друг другу: “Привет” Я подписан/на на тебя в Фейсбуке!”
                    </Text>
                    <Text>
